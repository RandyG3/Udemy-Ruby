=begin
    Review of Inheritance
        What is Inheritance
            ...
            Ruby only supports single inheritance. A class can only inherit from one
                other class
            ...
            A Car is a vehicle buy a Vehicle is not guaranteed to be a Car         
            Subclasses are followd by a < symbol and the name of the superclass
=end